...
for harvestedLink in harvestedLinks:
    ...
    anchorLinksNav = """<div class='link-wrapper'><ul class="nav navbar-nav"> <li><a href='#i125'>I-125</a></li><li><a href='#i131'>I-131</a></li></ul></div>"""

    anchorI125 = "<a id='i125'></a>"
    anchorI131 = "<a id='i131'></a>"
